            ...
            <div className="ProfileWrapper">
                ...
                <div>
                    <div className="SettingsWrapper">
                        ...
                        <div className="SettingsSection">
                            <h3>Currency</h3>
                            <select className="CurrencyDropdown" defaultValue="USD">
                        ...
                        <div className="SettingsSection">
                            ...
                            <button className="SettingsButton">Two-Factor Authentication</button>
                        </div>
                        
                        <div className="SettingsSection">
                            <h3>Account Management</h3>
                            <button className="SettingsButton SettingsDeleteButton">Delete Account</button>
                        </div>
                    </div>
                </div>
            </div> 
